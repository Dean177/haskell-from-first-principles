      ...
      Just _ -> do
        ...
        case preExistingUri of
          ...
          Right mbBS -> case mbBS of
            Just bs -> html (shortyDupeShortening uri (TL.pack shawty))
            Nothing -> do
...
redisConnectionInfo :: R.ConnectInfo
redisConnectionInfo = R.defaultConnectInfo {
...
main :: IO ()
main = do
  redisConnection <- R.connect redisConnectionInfo
  scotty 3000 (runReaderT app redisConnection)
